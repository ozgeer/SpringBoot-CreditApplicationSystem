...
import com.example.CreditApplicationSystem.constants.creditlimitvariable.IncomeAboveTenThousand;
...
public class GivenCreditIncomeAboveTenThousand implements GivenCreditType {
    ...
    public CreditApplyResponseDTO getCreditLimit(Client client, Double income, Double deposit) {
        ...
        if (deposit != 0) {
            Double plusage = deposit * IncomeAboveTenThousand.depositmultiple.getValue();
            creditLimit +=plusage;
